...
public interface QualificationRepository extends JpaRepository<QualificationEntity, Long> {
     ...
     * @return
     */
    @Query(value = "select * from mall_qualification where qualification_idnum = ?1 and qualification_realname = ?2", nativeQuery = true)
    QualificationEntity findAllByQualificationIDNumAndRealName(String qualification_idnum, String qualification_realname);
